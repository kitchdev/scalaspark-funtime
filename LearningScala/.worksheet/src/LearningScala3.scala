object LearningScala3 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(225); 
  ...
  transformInt(2, x => {val y = x * 2; y * y});System.out.println("""res2: Int = """ + $show(res$2));$skip(459); 
  ...
  //def bigWord (x: String) : String = {
  	//x.toUpperCase()
  //}
  var littleString: String = "booboo";System.out.println("""littleString  : String = """ + $show(littleString ));$skip(71); 
  def bigWord(x: String, f: String => String) : String = {
  	f(x)
  };System.out.println("""bigWord: (x: String, f: String => String)String""");$skip(45); val res$3 = 
  bigWord(littleString, x => x.toUpperCase);;System.out.println("""res3: String = """ + $show(res$3))}
}
