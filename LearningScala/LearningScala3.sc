object LearningScala3 {
  ...
  //def bigWord (x: String) : String = {
  	//x.toUpperCase()
  //}
  var littleString: String = "booboo"             //> littleString  : String = booboo
  def bigWord(x: String, f: String => String) : String = {
  	f(x)
  }                                               //> bigWord: (x: String, f: String => String)String
  bigWord(littleString, x => x.toUpperCase);      //> res3: String = BOOBOO
}